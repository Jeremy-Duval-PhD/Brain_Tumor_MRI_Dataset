...
def dialog_important_info():
    st.markdown(get_medical_disclaimer_markdown())
    st.divider()
    st.markdown(get_commercial_licence_markdown())
    st.divider()
...
## Commercial Use
Any commercial use requires a separate commercial license agreement.

Commercial use includes but is not limited to:
- integration into a paid product or service
- SaaS or hosted services
- clinical diagnostic services billed to patients or institutions
- use within proprietary medical software
